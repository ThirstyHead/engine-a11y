...
def render_pdf(
    ...
    fd, tmp_story = tempfile.mkstemp(suffix=".pdf", prefix="engine-a11y-story-")
    os.close(fd)
    ...
    try:
        ...
        print_rect = fitz.Rect(_MARGIN, _MARGIN, page_rect.width - _MARGIN, page_rect.height - _MARGIN)
        ...
        # Inject accessibility tags and catalog metadata using pikepdf
